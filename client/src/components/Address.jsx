      ...
      <div className="container my-3 p-4" style={{
        ...
        <form onSubmit={submitHandler} className="my-3">
          ...
          <div className="row">
            ...
            <div className="mb-3 col-md-4">
              ...
              <input
                ...
                type="text"
                className="form-control bg-dark text-light" id="exampleInputEmail1" aria-describedby="emailHelp" />
            </div>
            <div className="mb-3 col-md-4">
              <label htmlFor="exampleInputEmail1" className="form-label">
                Country
              ...
              <input
                ...
                onChange={onChangeHandler}
                type="text"
                className="form-control bg-dark text-light" id="exampleInputEmail123" aria-describedby="emailHelp" />
            </div>
            <div className="mb-3 col-md-4">
          ...
          <div className="d-grid col-6 mx-auto my-3">
            <button type="submit" className="btn btn-primary"  style={{fontWeigth:'bold'}}>
              Submit
            </button>
          </div>
        </form>
